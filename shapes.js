...
function notRecFunc() {
	if ( document.getElementById("rec1").checked) {
		document.getElementById("tickcontainerTwo").style.display = 'none';
	} else if (document.getElementById("rec2").checked) {
		document.getElementById("tickcontainerTwo").style.display = 'none';
	}
}
function circleFunc() {
...
function notCircleFunc() {
	if ( document.getElementById("circ1").checked) {
		document.getElementById("tickcontainerThree").style.display = 'none';
	} else if (document.getElementById("circ2").checked) {
		document.getElementById("tickcontainerThree").style.display = 'none';
	}
}
function triFunc() {
...
function notTriFunc() {
	if ( document.getElementById("tri1").checked) {
		document.getElementById("tickcontainerFour").style.display = 'none';
	} else if (document.getElementById("tri3").checked) {
		document.getElementById("tickcontainerFour").style.display = 'none';
	}
}
function heartFunc() {
...
function notHeartFunc() {
	if ( document.getElementById("heart1").checked) {
		document.getElementById("tickcontainerFive").style.display = 'none';
	} else if (document.getElementById("heart3").checked) {
		document.getElementById("tickcontainerFive").style.display = 'none';
	}
}
function ovalFunc() {
...
function notOvalFunc() {
	if ( document.getElementById("oval1").checked) {
		document.getElementById("tickcontainerSix").style.display = 'none';
	} else if (document.getElementById("oval3").checked) {
		document.getElementById("tickcontainerSix").style.display = 'none';
	}
}
function kiteFunc() {
...
function notKiteFunc() {
	if ( document.getElementById("kite2").checked) {
		document.getElementById("tickcontainerSev").style.display = 'none';
	} else if (document.getElementById("kite3").checked) {
		document.getElementById("tickcontainerSev").style.display = 'none';
	}
}
function starFunc() {
